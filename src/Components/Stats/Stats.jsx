...
const Stats = () => {
    return (
        <section className=' bg-linear-to-r from-[#4f39f6] to-[#9514fa] flex items-center py-10 justify-center gap-10'>
            <div className='text-white space-y-3 border-r border-white/50 text-center md:px-20 px-5'>
            ...
            <div className='text-white space-y-3  text-center md:px-20 px-5'>
