    ...
    return (
        <nav className='w-11/12 mx-auto flex items-center justify-between'>
            ...
            <div className='font-semibold flex items-center'>
                <button className="md:btn md:btn-ghost"><IoCartOutline /></button>
                <button className='btn btn-ghost'>Login</button>
                <button className='btn rounded-full bg-linear-to-r from-[#4f39f6] to-[#9514fa] shadow-none border-none'>Get Started</button>
            </div>
